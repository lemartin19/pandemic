...
export const TEST_GAME_3: SavedGame = {
  name: 'Test Game 3',
  players: [
    {
      name: 'Player 1',
      ...
      role: BASIC_ROLES.find((role) => role.name === 'Researcher')!,
    },
    {
      name: 'Player 2',
      color: '#e33946',
      ...
      currentLocation: 'Atlanta',
      role: BASIC_ROLES.find((role) => role.name === 'Dispatcher')!,
    },
  ],
  infections: {
    infections: {
  ...
  gamePlayQueue: [
    { type: 'waitingForPlayerAction', playerName: 'Player 1' },
    { type: 'waitingForPlayerAction', playerName: 'Player 1' },
    { type: 'waitingForPlayerAction', playerName: 'Player 1' },
    { type: 'waitingForPlayerDraw', playerName: 'Player 1' },
    { type: 'waitingForPlayerDraw', playerName: 'Player 1' },
    { type: 'infectCities' },
  ],
};
